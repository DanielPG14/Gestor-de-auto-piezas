...
public class Pieza {
    ...
    public Pieza(String nombre, String idEstante, int nivelAsigned, int stock, int capMax) {
        ...
        this.nombre = new SimpleStringProperty(nombre);
        this.razonSocialProveedor = new SimpleStringProperty("Sin Proveedor");
        this.codigoProveedor = new SimpleStringProperty("S/C");
        this.precioCompra = new SimpleDoubleProperty(0.0);
        this.imagen = new SimpleStringProperty("default.jpg");
        this.idEstante = new SimpleStringProperty(idEstante);
        this.nivelAsigned = new SimpleIntegerProperty(nivelAsigned);
        this.stock = new SimpleIntegerProperty(stock);
        this.capMax = new SimpleIntegerProperty(capMax);
    ...
    public String getRazonSocialProveedor() {
        return razonSocialProveedor.get();
    }
    ...
    public String getIdEstante() {
        return idEstante.get();
    }

    public int getNivelAsigned() {
        return nivelAsigned.get();
    }
    ...
    // PROPERTY METHODS
    public IntegerProperty idPiezaProperty() {
        return idPieza;
    }
    ...
    public StringProperty razonSocialProveedorProperty() {
        return razonSocialProveedor;
    }

    public StringProperty codigoProveedorProperty() {
    ...
    public StringProperty idEstanteProperty() {
        return idEstante;
    }

    public IntegerProperty nivelAsignedProperty() {
        return nivelAsigned;
    }
    ...
    public IntegerProperty capMaxProperty() {
        return capMax;
    }

    // SETTERS
    public void setIdPieza(int idPieza) {
        this.idPieza.set(idPieza);
    }
    ...
    public void setRazonSocialProveedor(String razonSocialProveedor) {
        this.razonSocialProveedor.set(razonSocialProveedor);
    }
    ...
    public void setIdEstante(String idEstante) {
        this.idEstante.set(idEstante);
    }

    public void setNivelAsigned(int nivelAsigned) {
        this.nivelAsigned.set(nivelAsigned);
    }
